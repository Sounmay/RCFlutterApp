...
class Snacks_MenuList extends StatefulWidget {
  @override
  _Snacks_MenuListState createState() => _Snacks_MenuListState();
}

class _Snacks_MenuListState extends State<Snacks_MenuList> {
  ...
  Widget build(BuildContext context) {
    return StreamProvider<List<SnacksMenu>>.value(
      value: DatabaseService().snackmenu,
      child: Scaffold(
        appBar: AppBar(
          backgroundColor: Colors.deepOrange,
          title: Text('Category: Snacks'),
          actions: <Widget>[
            IconButton(
              icon: Icon(
                Icons.shopping_cart,
...
class _SnacksMenuListListPageState extends State<SnacksMenuListListPage> {
  ...
  void addToCart(SnacksMenu post) {
  ...
  @override
  Widget build(BuildContext context) {
    final _menuList = Provider.of<List<SnacksMenu>>(context) ?? [];
