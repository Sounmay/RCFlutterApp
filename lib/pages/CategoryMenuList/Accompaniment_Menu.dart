...
class _Accompaniment_MenuState extends State<Accompaniment_Menu> {
  ...
  Widget build(BuildContext context) {
    return StreamProvider<List<AccompanimentMenu>>.value(
...
class _AccompanimentMenuListPageState extends State<AccompanimentMenuListPage> {
  ...
  @override
  Widget build(BuildContext context) {
    final _menuList = Provider.of<List<AccompanimentMenu>>(context) ?? [];
