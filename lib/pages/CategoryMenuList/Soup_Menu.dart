...
class Soup_MenuList extends StatefulWidget {
  @override
  _Soup_MenuListState createState() => _Soup_MenuListState();
}

class _Soup_MenuListState extends State<Soup_MenuList> {
  ...
  Widget build(BuildContext context) {
    return StreamProvider<List<SoupMenu>>.value(
      value: DatabaseService().soupmenu,
      child: Scaffold(
        appBar: AppBar(
          backgroundColor: Colors.deepOrange,
          title: Text('Category: Soup'),
          actions: <Widget>[
            IconButton(
              icon: Icon(
                Icons.shopping_cart,
...
class _SoupMenuListListPageState extends State<SoupMenuListListPage> {
  ...
  @override
  Widget build(BuildContext context) {
    final _menuList = Provider.of<List<SoupMenu>>(context) ?? [];
