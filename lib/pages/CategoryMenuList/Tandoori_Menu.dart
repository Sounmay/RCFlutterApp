...
class Tandoori_MenuList extends StatefulWidget {
  @override
  _Tandoori_MenuListState createState() => _Tandoori_MenuListState();
}

class _Tandoori_MenuListState extends State<Tandoori_MenuList> {
  ...
  Widget build(BuildContext context) {
    return StreamProvider<List<TandooriMenu>>.value(
      value: DatabaseService().tandoorimenu,
      child: Scaffold(
        appBar: AppBar(
        ...
        body: Column(
          children: <Widget>[
            Expanded(
              child: TandooriMenuListListPage(),
            )
          ],
        ),
      ),
...
class _TandooriMenuListListPageState extends State<TandooriMenuListListPage> {
  ...
  void addToCart(TandooriMenu post) {
