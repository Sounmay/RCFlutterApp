...
class _ChineseMenuListState extends State<ChineseMenuList> {
  ...
  Widget build(BuildContext context) {
    return StreamProvider<List<ChineseMenu>>.value(
...
class _ChineseMenuListPageState extends State<ChineseMenuListPage> {
  ...
  @override
  Widget build(BuildContext context) {
    final _menuList = Provider.of<List<ChineseMenu>>(context) ?? [];
