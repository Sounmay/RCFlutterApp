...
class StarterMenuList extends StatefulWidget {
  @override
  _StarterMenuListState createState() => _StarterMenuListState();
}

class _StarterMenuListState extends State<StarterMenuList> {
  ...
  Widget build(BuildContext context) {
    return StreamProvider<List<StarterMenu>>.value(
      value: DatabaseService().starter,
      child: Scaffold(
        appBar: AppBar(
...
class _StarterMenuListListPageState extends State<StarterMenuListListPage> {
  ...
  void addToCart(StarterMenu post) {
  ...
  @override
  Widget build(BuildContext context) {
    final _menuList = Provider.of<List<StarterMenu>>(context) ?? [];
