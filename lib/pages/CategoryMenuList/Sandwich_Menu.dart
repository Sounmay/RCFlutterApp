...
class Sandwich_MenuList extends StatefulWidget {
  @override
  _Sandwich_MenuListState createState() => _Sandwich_MenuListState();
}

class _Sandwich_MenuListState extends State<Sandwich_MenuList> {
  ...
  Widget build(BuildContext context) {
    return StreamProvider<List<SandwichMenu>>.value(
      value: DatabaseService().sandwichmenu,
      child: Scaffold(
        appBar: AppBar(
...
class _SandwichMenuListListPageState extends State<SandwichMenuListListPage> {
  ...
  void addToCart(SandwichMenu post) {
