...
class _Breakfast_MenuListState extends State<Breakfast_MenuList> {
  ...
  Widget build(BuildContext context) {
    return StreamProvider<List<BreadMenu>>.value(
      value: DatabaseService().breadmenu,
      child: Scaffold(
        appBar: AppBar(
          backgroundColor: Colors.deepOrange,
          title: Text('Category: Breakfast'),
          actions: <Widget>[
            IconButton(
              icon: Icon(
                Icons.shopping_cart,
...
class _BreadMenuListListPageState extends State<BreadMenuListListPage> {
  ...
  @override
  Widget build(BuildContext context) {
    final _menuList = Provider.of<List<BreadMenu>>(context) ?? [];
